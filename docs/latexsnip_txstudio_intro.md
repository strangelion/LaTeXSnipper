...
- **写论文：** LaTeX 代码、MathML、Word (.docx)、PDF
- **写博客：** Markdown、HTML、HTML 独立页、纯文本
- **做 Slides/网页：** SVG 矢量图、PNG 图片
- **发布电子书：** EPUB、ODT
- **做课件：** PowerPoint (.pptx)
- **玩新花样：** Typst（新兴排版语言）

桌面端目前提供 **20 种导出格式**。内置格式覆盖 LaTeX、Markdown、MathML、HTML、OMML 和 SVG；安装 Pandoc 层后增加 Word、ODT、PowerPoint、EPUB、PDF、HTML 独立页、Typst 和纯文本导出。
