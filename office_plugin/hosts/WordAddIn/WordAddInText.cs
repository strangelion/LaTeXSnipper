...
public static class WordAddInText
{
    ...
    private static string GetEn(string key)
    {
        return key switch
        {
            ...
            "ConvertingStatus" => "Rendering formula locally.",
            ...
            "NumberingTab" => "Numbering",
            "FormattingTab" => "Formatting",
            "SelectedScopeGroup" => "Selected Formula",
            "DocumentScopeGroup" => "Whole Document",
            ...
            "AllToOleButton" => "All to OLE",
            "AllToOmmlButton" => "All to Word",
            ...
            "AllToOleTip" => "Convert every managed formula in the document to OLE.",
            "AllToOmmlTip" => "Convert every managed formula in the document to native Word OMML.",
            "InsertReferenceButton" => "Insert Reference",
            "InsertReferenceTip" => "Insert a placeholder, then click a managed formula number to create a cross-reference.",
            "InsertChapterBoundaryButton" => "Chapter Boundary",
            "InsertSectionBoundaryButton" => "Section Boundary",
            "InsertChapterBoundaryTip" => "Insert a chapter boundary and restart nested automatic numbering.",
            "InsertSectionBoundaryTip" => "Insert a section boundary and restart formula numbering.",
            "FormatSelectedButton" => "Format Selected",
            "FormatAllButton" => "Format All",
            "FormatSelectedTip" => "Apply the configured font, color, weight, and size to selected formulas.",
            "FormatAllTip" => "Apply the configured formula color, weight, and size to all managed formulas.",
            "FormattingSettingsTip" => "Configure formula color, weight, and size.",
            "ReferencePlaceholderText" => "[Select a formula number]",
            "ChapterBoundaryText" => "Chapter boundary",
    ...
    private static string GetZh(string key)
    {
        return key switch
        {
            ...
            "NumberingTab" => "编号",
            "FormattingTab" => "格式化",
            "SelectedScopeGroup" => "所选公式",
            "DocumentScopeGroup" => "全文公式",
            "ReferenceGroup" => "交叉引用",
            "BoundaryGroup" => "编号边界",
            "FormattingGroup" => "公式样式",
            "ToOleButton" => "转为 OLE",
            "ToOmmlButton" => "转为 Word",
            "AllToOleButton" => "全文转 OLE",
            "AllToOmmlButton" => "全文转 Word",
            "ToOleSelectedTip" => "将所选受管公式转换为 OLE 公式对象。",
            "ToOmmlSelectedTip" => "将所选受管公式转换为 Word 原生 OMML。",
            "AllToOleTip" => "将文档中的全部受管公式转换为 OLE。",
            "AllToOmmlTip" => "将文档中的全部受管公式转换为 Word 原生 OMML。",
            "InsertReferenceButton" => "插入引用",
            "InsertReferenceTip" => "插入占位符后，单击受管公式编号生成交叉引用。",
            "InsertChapterBoundaryButton" => "章节分隔符",
            "InsertSectionBoundaryButton" => "节分隔符",
            "InsertChapterBoundaryTip" => "插入章编号边界并递归重置后续自动编号。",
            "InsertSectionBoundaryTip" => "插入节编号边界并重置后续公式编号。",
            "FormatSelectedButton" => "格式化所选",
            "FormatAllButton" => "格式化全文",
            "FormatSelectedTip" => "将设置中的字体、颜色、粗细度和大小应用于所选公式。",
            "FormatAllTip" => "将设置中的颜色、粗细和大小应用于全文受管公式。",
            "FormattingSettingsTip" => "配置公式颜色、粗细和大小。",
            "ReferencePlaceholderText" => "[请选择公式编号]",
            "ChapterBoundaryText" => "章节分隔符",
