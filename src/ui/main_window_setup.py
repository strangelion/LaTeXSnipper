...
class MainWindowSetupMixin:
    def __init__(self, startup_progress=None):
        ...
        self.share_history_button = PushButton(FluentIcon.SHARE, "共享")
        ...
        self.share_history_button.clicked.connect(self.show_lan_share_dialog)
        ...
        btn_row.addWidget(self.share_history_button)
